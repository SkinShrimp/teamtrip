...
function loadAssets() {
    assetLib = new Utils.AssetLoader(curLang, [
        {id: "background", file: "images/" + curLang + "/background.jpg"},
        {id: "helpScreen", file: "images/" + curLang + "/helpScreen.jpg"},
        {id: "titleScreen", file: "images/" + curLang + "/titleScreen.jpg"},
        {id: "rotateDeviceMessage", file: "images/rotateDeviceMessage.jpg"},
        {id: "splash", file: "images/splashScreen.jpg"},
        {id: "playBut", file: "images/" + curLang + "/playBut.png"},
        {id: "sgLogo", file: SG.getLogoUrl()},
        {id: "panels", file: "images/" + curLang + "/panels_379x159.png", oData: {columns: 4, spriteWidth: 379, spriteHeight: 159}},
        {id: "numbers", file: "images/numbers_17x36.png", oData: {columns: 3, spriteWidth: 17, spriteHeight: 36}},
        {id: "cards", file: "images/cards_128x173.png", oData: {columns: 9, spriteWidth: 128, spriteHeight: 173}},
        {id: "buttons", file: "images/" + curLang + "/buttons_131x133.png", oData: {columns: 4, spriteWidth: 131, spriteHeight: 133}},
        {id: "chips", file: "images/chips_133x133.png", oData: {columns: 2, spriteWidth: 133, spriteHeight: 133}}
...
if (typeof window.AudioContext !== "undefined" || typeof window.webkitAudioContext !== "undefined" || navigator.userAgent.indexOf("Android") == -1) {
    allowSound = true;
    sound = new Howl({urls: ["audio/sound.ogg", "audio/sound.m4a"], sprite: {click: [0, 150], cardHard: [250, 500], chip: [1e3, 300], bust: [1500, 750], win: [2500, 750], blackjack: [3500, 750], push: [4500, 750], cardSoft: [5500, 300], chipIntro: [6e3, 500]}})
}
var panel;
var background;
var bet = 0;
