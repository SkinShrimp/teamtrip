...
!function (e) {
    ...
    var n, a;
    !function (l, r) {
        "object" == typeof e && "object" == typeof e.exports ? e.exports = r(l) : (n = r, a = "function" == typeof n ? n.call(t, i, t, e) : n, !(void 0 !== a && (e.exports = a)))
    }("undefined" != typeof window ? window : this, function (e) {
        var t = e.document, i = e.location, n = navigator.userAgent, a = location.href, l = function (e, t) {
            e.className.indexOf(t) == -1 && (e.className += e.className.length > 0 ? " " + t : t)
        }, r = function (e, t) {
            e.className.indexOf(t) > -1 && (0 == e.className.indexOf(t) ? e.className = e.className.replace(t, "") : e.className = e.className.replace(" " + t, ""))
        }, o = function () {
            var o, s;
            this.handlerMap = {
                back: function () {
            ...
            }, this.mainElem = t.createElement("header"), this.leftElem = t.createElement("div"), this.rightElem = t.createElement("div"), this.titleElem = t.createElement("span"), this.leftCtrl = ["back"], this.rightCtrl = [], this.title = "", this.renderLeft = function () {
                for (var e = t.createDocumentFragment(), i = 0; i < this.leftCtrl.length; i++) {
                    var n = t.createElement("div");
                    n.className = "lvHeader-" + this.leftCtrl[i], n.style.position = "absolute", n.style.left = 35 * i + "px", n.style.bottom = 0, n.onclick = this.handlerMap[this.leftCtrl[i]] && this.handlerMap[this.leftCtrl[i]].bind(this), e.appendChild(n)
                }
                this.leftElem.appendChild(e)
            }, this.renderRight = function () {
                n.indexOf("CtClient") > -1 && (this.rightCtrl = this.rightCtrl.filter(function (e) {
                    return "category" != e && "home" != e
                }));
                for (var e = t.createDocumentFragment(), i = 0; i < this.rightCtrl.length; i++) {
                    var a = t.createElement("div");
                    a.className = "lvHeader-" + this.rightCtrl[i], a.style.position = "absolute", a.style.right = 35 * i + "px", a.style.bottom = 0, a.onclick = this.handlerMap[this.rightCtrl[i]] && this.handlerMap[this.rightCtrl[i]].bind(this), e.appendChild(a), "category" != this.rightCtrl[i] || this.isInitNav || this.renderNav()
                }
                this.rightElem.appendChild(e)
            }, this.init = function () {
                this.isShowNav = !1, this.isInitNav = !1, this.mainElem.className = "lvHeader-main", this.leftElem.className = "lvHeader-left", this.rightElem.className = "lvHeader-right", this.titleElem.className = "lvHeader-title", this.renderLeft(), this.renderRight();
                var e = t.createTextNode(this.title);
                this.titleElem.appendChild(e), this.mainElem.appendChild(this.leftElem), this.mainElem.appendChild(this.titleElem), this.mainElem.appendChild(this.rightElem), (n.indexOf("iPhone") > -1 || n.indexOf("iPad") > -1) && n.indexOf("LVMM") > -1 && (this.mainElem.style.paddingTop = "20px", this.mainElem.style.height = "65px"), 375 === screen.width && 812 === screen.height && n.indexOf("LVMM") > -1 && (this.mainElem.style.paddingTop = "24px", this.mainElem.style.height = "69px"), t.body.appendChild(this.mainElem)
            }, this.renderNav = function () {
                var a = [{
                        text: "景点门票",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-ticket-min.png",
                        toUrl: "//m.lvmama.com/webapp/ticket/"
                    }, {
                        text: "周边游",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-around-min.png",
                        toUrl: "//m.lvmama.com/around/"
                    }, {
                        text: "酒店",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-hotel-min.png",
                        toUrl: "//m.lvmama.com/hotel/"
                    }, {
                        text: "国内游",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-destroute-min.png",
                        toUrl: "//m.lvmama.com/destroute/"
                    }, {
                        text: "出境游",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-abroad-min.png",
                        toUrl: "//m.lvmama.com/abroad/"
                    }, {
                        text: "邮轮",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-youlun-min.png",
                        toUrl: "//m.lvmama.com/youlun"
                    }, {
                        text: "机票",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-flight-min.png",
                        toUrl: "//m.lvmama.com/flight/"
                    }, {
                        text: "火车票",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-train-min.png",
                        toUrl: "//m.lvmama.com/train/"
                    }, {
                        text: "签证",
                        imgUrl: "//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/nav-visa-min.png",
                        toUrl: "//m.lvmama.com/visa/mainPage"
                    }], r = t.createElement("div"), o = t.createElement("ul"), s = t.createElement("ul"),
                    d = t.createElement("div");
                r.className = "lvHeader-nav", o.className = "nav-list", s.className = "nav-foot";
                for (var h = 0; h < a.length; h++) {
                    var p = t.createElement("li"), c = t.createElement("span"), g = t.createTextNode(a[h].text);
                    c.appendChild(g), c.dataset.bgsrc = a[h].imgUrl, p.appendChild(c), (h + 1) % 3 == 0 && (p.style.borderRight = "none"), p.onclick = function (e) {
                        return function () {
                            i.href = a[e].toUrl
                        }
                    }(h), o.appendChild(p), (n.indexOf("iPhone") > -1 || n.indexOf("iPad") > -1) && n.indexOf("LVMM") > -1 && (r.style.top = "65px")
                }
                var A = t.createElement("li"), m = t.createElement("span"), f = t.createTextNode("未登录"),
                    v = t.createElement("i");
                m.appendChild(f), m.className = "non-login", v.style.background = "url(//pics.lvjs.com.cn/mobile/plugins/nativeJs/lvHeader/1.0/imgs/navfoot-lv-min.png) no-repeat", v.style.backgroundSize = "cover", m.appendChild(v), A.appendChild(m), s.appendChild(A);
                var u = t.createElement("li"), b = t.createElement("span"), E = t.createTextNode("首页");
                b.appendChild(E), b.className = "navfoot-home", u.appendChild(b), u.onclick = this.handlerMap.home, s.appendChild(u);
                var C = t.createElement("li"), x = t.createElement("span"), k = t.createTextNode("登录/注册");
                x.appendChild(k), x.className = "navfoot-login", C.appendChild(x), C.onclick = this.jumpLogin, s.appendChild(C), d.className = "lvHeader-nav-mask", d.onclick = this.showNav.bind(this), d.style.display = "none", r.appendChild(o), r.appendChild(s), r.style.display = "none", t.body.appendChild(r), t.body.appendChild(d), this.isLogin = function () {
                    if (e.loginUtil) loginUtil.isLogin(function (e) {
                        "1" == e.code && (v.style.background = "url(" + e.data.imageUrl + ") no-repeat", v.style.backgroundSize = "cover", l(A, "logged-in"), l(C, "logged-in"), m.innerText = e.data.userName, x.innerText = "注销", m.appendChild(v), C.onclick = loginUtil.logout)
                    }); else {
                        var t = document.createElement("script");
                        t.type = "text/javascript", t.src = "//pics.lvjs.com.cn/mobile/plugins/nativeJs/login/1.0/build.min.js", t.onload = function () {
                            loginUtil.isLogin(function (e) {
                                "1" == e.code && (v.style.background = "url(" + e.data.imageUrl + ") no-repeat", v.style.backgroundSize = "cover", l(A, "logged-in"), l(C, "logged-in"), m.innerText = e.data.userName, x.innerText = "注销", m.appendChild(v), C.onclick = loginUtil.logout)
                            })
                ...
                e.clearTimeout(o), e.clearTimeout(s);
                var i = t.getElementsByClassName("lvHeader-nav"), n = t.getElementsByClassName("lvHeader-nav-mask"),
                    a = i[0].getElementsByClassName("nav-list")[0].getElementsByTagName("span");
                this.isShowNav ? (r(i[0], "active"), r(t.getElementsByClassName("lvHeader-category")[0], "show-category"), s = e.setTimeout(function () {
                    i[0].style.display = "none"
                }, 200), n[0].style.display = "none") : (i && i[0] ? (this.isInitNav || this.isLogin(), i[0].style.display = "block", l(t.getElementsByClassName("lvHeader-category")[0], "show-category"), o = e.setTimeout(function () {
                    l(i[0], "active")
                }, 10)) : (this.renderNav(), this.showNav()), n[0].style.display = "block");
                for (var d in a) if (a[d].style && "" == a[d].style.background) {
                    var h = a[d].dataset.bgsrc;
                    a[d].style.background = "url(" + h + ") no-repeat center left", a[d].style.backgroundSize = "32px"
                }
                this.isShowNav = !this.isShowNav
            }, this.jumpLogin = function () {
                loginUtil.gotoLogin({callbackUrl: i.href})
            }, this.cutTitle = function () {
                var e = t.body.offsetWidth, i = this.titleElem.offsetWidth, n = 45 * this.rightCtrl.length || 45,
                    a = this.titleElem.innerText;
                if (a.length > 6) for (; 2 * n + i > e && (a = a.replace("...", ""), a = a.substring(0, a.length - 1), a += "...", this.titleElem.innerText = a, i = this.titleElem.offsetWidth, !(this.titleElem.innerText.length <= 9));) ;
            }, e.NativeUtil && NativeUtil.isLVMM ? NativeUtil.lvCommon("lvJSShowNativeNavigationBar") : a.indexOf("isHideHeader=1") === -1 && this.init()
        };
        o.prototype = {
            setTitle: function (e) {
                return this.titleElem.innerText = e, this.cutTitle(), this
            }, setLeft: function (e) {
                if (!e || e.length != this.leftCtrl || e.toString != this.leftCtrl.toString()) {
                    for (; this.leftElem.hasChildNodes();) this.leftElem.removeChild(this.leftElem.firstChild);
                    this.leftCtrl = e || [], this.renderLeft()
                }
                return this.cutTitle(), this
            }, setRight: function (e) {
                if (!e || e.length != this.rightCtrl || e.toString != this.rightCtrl.toString()) {
                    for (; this.rightElem.hasChildNodes();) this.rightElem.removeChild(this.rightElem.firstChild);
                    this.rightCtrl = e || [], this.renderRight()
                }
                return this.cutTitle(), this
            }, appendLeft: function (e) {
                for (var i = 0; i < e.length; i++) if (!this.leftCtrl || this.leftCtrl.indexOf(e[i]) == -1) {
                    var n = t.createElement("div");
                    n.className = "lvHeader-" + e[i], n.style.position = "absolute", n.style.left = 35 * this.leftCtrl.length + "px", n.style.bottom = 0, n.onclick = this.handlerMap[e[i]].bind(this), this.leftElem.appendChild(n), this.rightCtrl.push(e[i])
                }
                return this.cutTitle(), this
            }, appendRight: function (e) {
                n.indexOf("CtClient") > -1 && (e = e.filter(function (e) {
                    return "category" != e && "home" != e
                }));
                for (var i = 0; i < e.length; i++) if (!this.rightCtrl || this.rightCtrl.indexOf(e[i]) == -1) {
                    var a = t.createElement("div");
                    a.className = "lvHeader-" + e[i], a.style.position = "absolute", a.style.right = 35 * this.rightCtrl.length + "px", a.style.bottom = 0, a.onclick = this.handlerMap[e[i]].bind(this), this.rightElem.appendChild(a), this.rightCtrl.push(e[i]), "category" == e[i] && this.renderNav()
                }
                return this.cutTitle(), this
            }, setHandler: function (e, i) {
                return (this.leftCtrl.indexOf(e) > -1 || this.rightCtrl.indexOf(e) > -1) && (this.handlerMap[e] = i, t.getElementsByClassName("lvHeader-" + e)[0] && (t.getElementsByClassName("lvHeader-" + e)[0].onclick = this.handlerMap[e].bind(this))), this
            }, setFavourite: function () {
                var e = t.getElementsByClassName("lvHeader-favourite")[0];
                return e && l(e, "favourited"), this.isFavourite = !0, this
            }, cancelFavourite: function () {
                var e = t.getElementsByClassName("lvHeader-favourite")[0];
                return e && r(e, "favourited"), this.isFavourite = !1, this
            }, hide: function () {
                var e = t.getElementsByClassName("lvHeader-nav")[0],
                    i = t.getElementsByClassName("lvHeader-nav-mask")[0];
                return this.mainElem.style.display = "none", e && (e.style.display = "none"), i && (i.style.display = "none"), this
            }, show: function () {
                return this.mainElem.style.display = "block", this
            }
        }, e.lvHeader = new o
    })
}, function (e, t, i) {
    ...
    t = e.exports = i(4)(), t.push([e.id, ".lvHeader-main *,.lvHeader-nav *{margin:0;padding:0;box-sizing:border-box;-webkit-tap-highlight-color:transparent;outline:0;font-family:microsoft yahei,Arial}.lvHeader-main ul,.lvHeader-nav ul{list-style:none}.lvHeader-main{margin:0;padding-left:0;padding-right:0;width:100%;height:45px;position:fixed;top:0;left:0;text-align:center;line-height:45px;font-size:19px;background-color:#fff;z-index:1002;border:0;box-sizing:border-box}.lvHeader-main .lvHeader-title{font-size:19px;position:relative;left:0;color:#000;word-break:break-all}.lvHeader-main>div>div{height:45px;width:35px}.lvHeader-main>div{overflow:hidden}.lvHeader-main>div .lvHeader-back{background:url(" + i(5) + ") no-repeat 50%;background-size:10px}.lvHeader-main>div .lvHeader-category{background:url(" + i(6) + ') no-repeat 50%;background-size:21px}.lvHeader-main>div .lvHeader-category.show-category:after{content:"";width:10px;height:10px;position:absolute;bottom:-6px;left:13px;border-image:url(data:image/gif;base64,R0lGODlhBQAFAPABANra2v///yH5BAUHAAEALAAAAAAFAAUAAAIHhB9pGatnCgA7) 2 stretch;border-left:1px solid;border-top:1px solid;border-bottom:0;border-right:0;background-color:#fff;transform:rotate(45deg);-webkit-transform:rotate(45deg);z-index:1003}.lvHeader-main>div .lvHeader-home{background:url(' + i(7) + ") no-repeat 50%;background-size:25px}.lvHeader-main>div .lvHeader-search{background:url(" + i(8) + ") no-repeat 50%;background-size:22px}.lvHeader-main>div .lvHeader-favourite{background:url(" + i(9) + ") no-repeat 50%;background-size:25px}.lvHeader-main>div .lvHeader-favourite.favourited{background:url(" + i(10) + ") no-repeat 50%;background-size:25px}.lvHeader-main>div .lvHeader-share{background:url(" + i(11) + ') no-repeat 50%;background-size:25px}.lvHeader-nav{width:100%;height:205px;position:fixed;top:45px;background-color:#f8f8f8;z-index:1001;transform:translate3d(0,-45px,0);-webkit-transform:translate3d(0,-198px,0);transition:translate3d 1s ease;-webkit-transition:transform .3s ease}.lvHeader-nav.active{transform:translateZ(0);-webkit-transform:translateZ(0)}.lvHeader-nav ul{width:100%;overflow:hidden}.lvHeader-nav ul li{width:33.3%;height:55px;float:left;border-image:url(data:image/gif;base64,R0lGODlhBQAFAPABANra2v///yH5BAUHAAEALAAAAAAFAAUAAAIHhB9pGatnCgA7) 2 stretch;border-bottom:1px solid;border-right:1px solid;border-top:0;border-left:0;background-color:#fff;padding-top:7px}.lvHeader-nav ul li span{display:block;width:90px;height:40px;margin:0 auto;line-height:40px;padding-left:38px;font-size:12px;color:#000}.lvHeader-nav ul.nav-foot li{height:40px;background-color:inherit;padding-top:0;border:none;position:relative}.lvHeader-nav ul.nav-foot li:after{content:"";width:0;height:20px;border-image:url(data:image/gif;base64,R0lGODlhBQAFAPABANra2v///yH5BAUHAAEALAAAAAAFAAUAAAIHhB9pGatnCgA7) 2 stretch;border-right:1px solid;border-left:0;border-top:0;border-bottom:0;position:absolute;right:0;top:10px}.lvHeader-nav ul.nav-foot li:last-child:after{height:0;border:0}.lvHeader-nav ul.nav-foot li span{font-weight:400;font-size:10px;color:#333;padding-left:30px;width:75px;position:relative}.lvHeader-nav ul.nav-foot li span:first-child i{width:20px;height:20px;position:absolute;left:5px;top:10px;border-radius:20px}.lvHeader-nav ul.nav-foot li span.non-login{color:#999}.lvHeader-nav ul.nav-foot li.logged-in span.non-login{line-height:29px;color:#333;width:80px;overflow:hidden;text-overflow:ellipsis}.lvHeader-nav ul.nav-foot li.logged-in span.non-login:after{content:"\\5DF2\\767B\\5F55";position:absolute;bottom:-2px;left:30px;color:#999}.lvHeader-nav ul.nav-foot li span.navfoot-home{width:60px;background:url(' + i(12) + ") no-repeat 0;background-size:25px}.lvHeader-nav ul.nav-foot li span.navfoot-login{background:url(" + i(13) + ") no-repeat 0;background-size:25px;width:83px}.lvHeader-nav ul.nav-foot li.logged-in span.navfoot-login{background:url(" + i(14) + ") no-repeat 0;background-size:25px;width:60px}.lvHeader-nav-mask{width:100%;height:100%;position:fixed;top:0;z-index:1000}.lvHeader-nav-mask,.lvHeader-nav-mask:active{background-color:rgba(0,0,0,.3)}", ""])
}, function (e, t) {
    e.exports = function () {
        var e = [];
    ...
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACoAAAAiCAYAAAApkEs2AAAAYklEQVRYw+3WsQnAIBgF4bNyqWQsJ4yZwIG0sJFAIJX8gXuViMUHNpdaLhdwMFeBk4BLLZf+vHt524V+hK5ffy/ncF/PHyZUqFChQoXGg5p5Zp6ZJ1SoUKFChZp51pOZt3kD3m9Em64cZgcAAAAASUVORK5CYII="
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t) {
    e.exports = "data:image/png;base64,"
}, function (e, t, i) {
    function n(e, t) {
        for (var i = 0; i < e.length; i++) {
            ...
            if (a) {
                ...
                for (; l < n.parts.length; l++) a.parts.push(d(n.parts[l], t))
            } else {
                for (var r = [], l = 0; l < n.parts.length; l++) r.push(d(n.parts[l], t));
                g[n.id] = {id: n.id, refs: 1, parts: r}
            }
        }
    }
    ...
    function a(e) {
        for (var t = [], i = {}, n = 0; n < e.length; n++) {
            var a = e[n], l = a[0], r = a[1], o = a[2], s = a[3], d = {css: r, media: o, sourceMap: s};
            i[l] ? i[l].parts.push(d) : t.push(i[l] = {id: l, parts: [d]})
        }
        return t
    }

    function l(e, t) {
        var i = f(), n = b[b.length - 1];
    ...
    function d(e, t) {
        ...
        if (t.singleton) {
            var l = u++;
            i = v || (v = o(t)), n = h.bind(null, i, l, !1), a = h.bind(null, i, l, !0)
        } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = s(t), n = c.bind(null, i), a = function () {
            r(i), i.href && URL.revokeObjectURL(i.href)
        }) : (i = o(t), n = p.bind(null, i), a = function () {
            r(i)
        });
    ...
    function c(e, t) {
        ...
        var a = new Blob([i], {type: "text/css"}), l = e.href;
